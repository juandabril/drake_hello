...
def run_app():
    st.set_page_config(page_title="Drake Pendulum Lab", layout="wide")
    st.title("Drake Pendulum Lab")
    st.caption("Interactive closed-loop pendulum simulation with PD control.")
